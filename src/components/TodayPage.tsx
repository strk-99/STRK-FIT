...
export function TodayPage() {
    ...
    return (
        <div className="px-4 pt-4 pb-24 space-y-6 animate-fade-up">
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    <h2 className="font-bold uppercase tracking-wider text-sm text-sky-400">Tasks</h2>
                    {tasks.length > 0 && (
                ...
                <button onClick={() => setShowAddForm(v => !v)}
                    className="w-full flex items-center justify-center gap-2 bg-sky-700/40 hover:bg-sky-700/60 border border-sky-800/50 text-sky-300 font-bold py-2.5 rounded-lg transition-colors text-sm">
